...
/**
 * Convert a pepecoin URI string into a simple object.
 *
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'pepecoin:') {
    throw new TypeError('Invalid pepecoin URI');
  }
 ...
 * @throws {TypeError} Invalid pepecoin address
 * @throws {TypeError} Invalid amount
 * @throws {Error} Unknown required argument
 */
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid pepecoin address');
  }
 ...
 *
 * @returns {string} Pepecoin URI string
 */
